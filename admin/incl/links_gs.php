    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="page-breadcrumb" style="padding-left:30px; padding-right: 30px; padding-top:0px; padding-bottom: 0px">
                <div class="row align-items-center">
                    <div class="col-6">
                      ...
                      <h1 class="mb-0 fw-bold">GeoServer Connections</h1>
                    </div>
                    <div class="col-6">
                        <div class="text-end upgrade-btn">
													<button type="button" class="btn btn-primary text-white add-new" onclick="window.location.href='select_<?=$tab?>.php';" >
      ...
      <div class="container-fluid">
				...
				<ul class="nav nav-tabs">
					<li class="nav-item"><a class="nav-link <?php if($tab == 'pg') { ?> active <?php } ?>" href="links.php?tab=pg">PostGIS</a> </li>
					<li class="nav-item"><a class="nav-link <?php if($tab == 'gs') { ?> active <?php } ?>" href="links.php?tab=gs">GeoServer</a></li>
					<li class="nav-item"><a class="nav-link <?php if($tab == 'import') { ?> active <?php } ?>" href="links.php?tab=import">Create</a></li>
				</ul>
    ...
    <div class="row">
        <div class="col-6">
					<div id = "repThumbnail" class = "alert alert-success">
					   ...
					   <strong>Note:</strong>Enter your credentials for Geoserver
					</div>
